...
deep_researcher_builder.add_node("final_travel_plan_generation", final_travel_plan_generation)

# Add workflow edges
deep_researcher_builder.add_edge(START, "clarify_with_user")
deep_researcher_builder.add_edge("write_travel_research_brief", "supervisor_subgraph")
deep_researcher_builder.add_edge("supervisor_subgraph", "final_travel_plan_generation")
deep_researcher_builder.add_edge("final_travel_plan_generation", END)

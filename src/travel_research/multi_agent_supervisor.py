...
supervisor_model = ChatAnthropic(
    model="claude-sonnet-4",   # Or "claude-3-opus-20240229", etc.
    api_key=CLAUDE_API_KEY,
    base_url=LLM_API_ENDPOINT,             # Your Anthropic API key
    temperature=0,
    max_tokens=64000,                      # You can set a limit if needed
    timeout=None,
    max_retries=2,
)
    ...
    if exceeded_iterations or no_tool_calls or research_complete:
        ...
        try:
            ...
            if conduct_research_calls:
                ...
                # Each sub-agent returns compressed travel research findings in result["compressed_research"]
